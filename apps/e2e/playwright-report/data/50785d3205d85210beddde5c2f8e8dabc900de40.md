...
- Name: smoke.spec.ts >> Beerpong Smoke Tests >> should redirect to signin when accessing /app without session
- Location: tests\smoke.spec.ts:11:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/app
Call log:
